...
import { VStack, Center, Text, Box, ScrollView } from "@gluestack-ui/themed";
      ...
      <VStack flex={1} bg="$gray600">
        <VStack flex={1} px="$12" pb="$9">
          ...
          <Center gap="$4">
            ...
            />
            <Button mt="$8" title="Entrar" buttonColor="blue" />
          </Center>
          ...
          <Center flex={1} >
            ...
            <Button title="Criar uma conta" buttonColor="gray" />
          </Center>
